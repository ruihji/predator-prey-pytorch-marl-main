...
class ActiveAgent(object):
    def __init__(self, args, action_dim=5):
        self.map_size = args.map_size
        self._action_dim = action_dim
        self._n_predator = args.n_predator
        self._n_prey = args.n_prey
        self._state_dim = 2 * (self._n_predator + self._n_prey)


    def choose_action(self, state, num):
        ...
        for j in range(self._n_predator):
    ...
    def state_to_index(self, state):
            ...
            for i in range(self._n_predator + self._n_prey):
