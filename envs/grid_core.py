...
class Wall(Entity):
    def __init__(self, itype='wall', color='grey'):
        super(Wall, self).__init__(itype, color)
...
class World(object):
    ...
    def resetObj(self, obj, top=None, size=None, reject_fn=None):
        """
        Reset an object at an empty position in the grid
